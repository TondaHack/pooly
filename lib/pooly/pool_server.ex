defmodule Pooly.PoolServer do
  ...
  defmodule State do
    defstruct pool_sup: nil, worker_sup: nil, monitors: nil, size: nil, workers: nil, name: nil,  mfa: nil, overflow: nil, max_overflow: nil, waiting: nil
  end
  ...
  defp supervisor_spec(name, mfa) do
    opts = [name: name <> "WorkerSupervisor", restart: :temporary]
